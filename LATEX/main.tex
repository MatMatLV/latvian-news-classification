...
\textbf{LSTM} - rekurentā mākslīgā neironu tīkla paveids ar atmiņas elementu (angliski - Long Short-Term Memory)

\textbf{GLUE} - standartizēta pieeja valodas apstrādes modeļu veiktspējas novērtēanai, sevī ietver 9 dažādus valodas apstrādes uzdevumus (angliski - General Language Understanding Evaluation)
